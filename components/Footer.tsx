        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/products" className="text-slate-400 hover:text-accent transition-colors">
              ...
              <li>
                <Link href="/specs" className="text-slate-400 hover:text-accent transition-colors">
                  {t('nav.specs')}
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/systems" className="text-slate-400 hover:text-accent transition-colors">
              ...
              <li>
                <Link href="/projects" className="text-slate-400 hover:text-accent transition-colors">
                  {t('nav.projects')}
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/configurator" className="text-slate-400 hover:text-accent transition-colors">
                  {lang === 'en' ? 'Glass Configurator' : 'مكون الزجاج'}
                </Link>
              </li>
              <li>
                <Link href="/case-studies" className="text-slate-400 hover:text-accent transition-colors">
              ...
              <li>
                <Link href="/brand-guidelines" className="text-slate-400 hover:text-accent transition-colors">
