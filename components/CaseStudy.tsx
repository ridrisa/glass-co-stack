    ...
    <article className="max-w-7xl mx-auto px-6 py-16">
      ...
      >
        <div className="relative h-[60vh] rounded-2xl overflow-hidden mb-8">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8">
            <div className="text-sm text-white/80 mb-2">{caseStudy.sector}</div>
      ...
      >
        ...
        <div className="glass rounded-xl p-8">
          <p className="text-white/90 text-lg leading-relaxed">{caseStudy.problem}</p>
        </div>
      </motion.section>
      ...
      >
        ...
        <div className="glass rounded-xl p-8">
          <p className="text-white/90 text-lg leading-relaxed">{caseStudy.solution}</p>
        </div>
      </motion.section>
      ...
      >
        ...
        <div className="glass rounded-xl p-8 bg-accent/10 border-accent/20">
          <p className="text-white/90 text-lg leading-relaxed">{caseStudy.outcome}</p>
        </div>
      </motion.section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {caseStudy.hseStats.trir !== undefined && (
              <div className="glass rounded-xl p-6">
                ...
                <div className="text-sm text-white/70">TRIR</div>
              </div>
            )}
            {caseStudy.hseStats.ltif !== undefined && (
              <div className="glass rounded-xl p-6">
                ...
                <div className="text-sm text-white/70">LTIF</div>
              </div>
            )}
