        ...
        <GlassShimmer className="overflow-hidden hover:scale-105 transition-transform duration-300 cursor-pointer h-full">
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-2 gap-4 mb-4 pb-4 border-b border-white/10">
              <div>
                <div className="text-xs text-white/50 mb-1">Area</div>
                <div className="text-white font-semibold">{area}</div>
              </div>
              <div>
                <div className="text-xs text-white/50 mb-1">System</div>
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-sm text-white/70 line-clamp-2">{challenge}</p>
              </div>
              <div>
                <div className="text-xs text-accent font-semibold mb-1">Solution</div>
                <p className="text-sm text-white/70 line-clamp-2">{solution}</p>
              </div>
            </div>
