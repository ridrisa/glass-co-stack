...
export default function OnePager({
  ...
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="max-w-4xl mx-auto bg-white text-ink p-12 shadow-2xl print:shadow-none"
    >
      {/* Header */}
      ...
      <footer className="border-t-2 border-ink/10 pt-8 mt-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm text-ink/70">
          <div>
