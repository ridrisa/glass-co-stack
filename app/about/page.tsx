          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <motion.div {...glassFloat} transition={{ delay: 0.1 }}>
              <GlassShimmer className="p-8 text-center h-full" enable3DTilt maxTilt={8}>
                ...
                <div className="text-slate-300">{lang === 'en' ? 'Projects Across KSA' : 'مشروع عبر المملكة'}</div>
            ...
            <motion.div {...glassFloat} transition={{ delay: 0.2 }}>
              <GlassShimmer className="p-8 text-center h-full" enable3DTilt maxTilt={8}>
                ...
                <div className="text-slate-300">{lang === 'en' ? 'Days Lead Time' : 'يوم وقت التسليم'}</div>
            ...
            <motion.div {...glassFloat} transition={{ delay: 0.3 }}>
              <GlassShimmer className="p-8 text-center h-full" enable3DTilt maxTilt={8}>
                ...
                <div className="text-slate-300">{lang === 'en' ? 'Saudi Building Code' : 'الكود السعودي للبناء'}</div>
