          ...
          <div className="mt-20 glass rounded-xl p-8 md:p-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-slate-300">$50M aggregate coverage</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-accent mb-2">
                  Workers Compensation
                </h3>
                <p className="text-slate-300">Full coverage for all employees</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-accent mb-2">
                  Performance Bonds
                </h3>
                <p className="text-slate-300">Up to $200M single project capacity</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-accent mb-2">
                  Professional Liability
                </h3>
                <p className="text-slate-300">$25M E&O coverage</p>
              </div>
            </div>
          </div>
        </div>
